...
public:
  ...
  // the GridBase instance is used (and to call at::Tensor_(free) if required).
  // TODO(tompson): This class should really be pure virtual.
  explicit tfluids_(GridBase)(at::Tensor* grid, bool is_3d);
...
protected:
  ...
  // batch dim), this is taken care of in at::Tensor_(data) (i.e. it returns
...
public:
  explicit tfluids_(FlagGrid)(at::Tensor* grid, bool is_3d);
...
public:
  explicit tfluids_(RealGrid)(at::Tensor* grid, bool is_3d);
...
public:
  explicit tfluids_(MACGrid)(at::Tensor* grid, bool is_3d);
...
public:
  explicit tfluids_(VecGrid)(at::Tensor* grid, bool is_3d);
